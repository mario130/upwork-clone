          ...
          <div className="bg-white mb-5">
            <ul className="list-group">
              <li className="item-border flex justify-between ">
                ...
                <Btn className="bg-primary text-white disabled:opacity-50 px-10 py-2 disabled:cursor-not-allowed">Post Job Now</Btn>
              </li>
          ...
          <div className="bg-white mb-5">
            <ul className="list-group">
              ...
              <div className="mb-5 w-full md:w-3/6">
                    <h5 className="text-sm font-bold mb-4">Hourly or Fixed-Price</h5>
                    <p>{jobPost.paymentChioce}</p>
             </div>
             <div className="mb-5 w-full md:w-3/6">
