...
const Jobs = () => {
  ...
  return (
    <>
      <Navbar />
      <h1 className="px-4 md:px-6 py-2 mt-6 mb-3 font-bold text-2xl lg:container lg:mx-auto lg:max-w-5xl">{job.title}</h1>  
      <div className="bg-white mb-6 md:rounded-lg md:mx-12 lg:container lg:mx-auto lg:max-w-5xl border border-gray-200">
        <div className="">
          <h2 className="p-4 md:px-6 border-b border-gray-200 text-complementary text-xl font-bold">Applicants ({applicants.length})</h2>

          {applicants.map(applicant => (
            <div className="p-4 md:px-6 border-b border-gray-200 lg:flex">
              <div className="flex py-2">
                <img src={applicant.imageUrl} className="w-16 h-16 rounded-full mr-4 md:mr-6" alt=""/>
                <div>
                  <h4 className="text-primary font-bold">{applicant.name}</h4>
