...
const Profile = () => {
  const [freelancer] = useState({
    description: "Developer with 10+ years of experience. Have been working for different areas from enterprise, web & mobile to game development. Looking for a project with clear requirements and product goals, high technology level, responsibility for results",
    pastJobs: [
      {
        type: 'Hourly',
        title: "Full Stack Dev Support - Native App & Backend .Net, XAML, MONGO DB",
        rating: 5,
        feedback: "He came up to speed very quickly on project. Unfortunately out project is approaching funding, and we do not have continuous work for he at this point. He decided to jump on another project until we have a more steady workflow and team for him.",
        earned: 2370,
        hourlyRate: 30,
        totalHours: 79,
        // todo: add date range
      },
      {
        ...
        rating: 4.4,
        feedback: "He did a great job creating the App for us from scratch. We can't wait till we work with him again. Excellent communications and adherence to timelines",
        earned: 500,
      },
    ],
    portfolio: [
    ...
    education: [
      {
        ...
        speciality: "Master of Computer Applications (M.C.A.), Applied Mathematics",
        duration: "2008-2014"
      }
    ],
    employmentHistory: [
  ...
  return (
    <div className="bg-gray-100 mt-4">
      <div className="flex p-4 bg-white border md:rounded-lg mb-3">
        ...
        <div className="flex-1">
          ...
          <div className="mt-6 flex">
            ...
            <h4 className="uppercase text-complementary font-extrabold tracking-wide text-xs">rising talent</h4>
          </div>
        </div>
      </div>

      {/* Earnings */}
      <div className="flex p-4 bg-white border md:rounded-lg mb-3 justify-between">
        <div>
          <h4 className="font-extrabold">$3k</h4>
          <p className="text-sm">Total Earnings</p>
        </div>
        <div>
          <h4 className="font-extrabold">21</h4>
      ...
      {/* Main profile */}
      <div className="bg-white border md:rounded-lg mb-3">
        <div className="p-4 flex">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 ml-3 border rounded-full p-1" viewBox="0 0 20 20" fill="currentColor">
            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
          </svg>
        </div>

        <div className="px-4">
          <select name="profile" id="profile" className="px-4 py-1 w-full border border-gray-200 rounded-lg bg-white text-sm">
        ...
        <div className="px-4 flex mt-6 items-center">
        ...
        <div className="px-4 flex mt-4 items-center">
        ...
        <div className="p-4 flex border-b border-gray-200">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 ml-3 border rounded-full p-1 flex-3 mt-5" viewBox="0 0 20 20" fill="currentColor">
            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
          </svg>
        </div>
        ...
        <div className="mb-4">
          <div className="p-4 flex items-center mb-4">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 ml-3 border rounded-full p-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 12h.01M12 12h.01M19 12h.01M6 12a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0z" />
            </svg>
          </div>

          <ul className="px-4 pt-4 mb-4 flex text-primary font-bold border-b border-gray-200">
            <li className="border-b-2 border-primary">Completed jobs (21)</li>
          </ul>
          ...
          {freelancer.pastJobs.map(job => (
            <div className="p-4 border-b border-gray-200">
              ...
              <div className="flex items-center">
                {Array.apply(null, { length: Math.floor(job.rating) }).map((e, i) => (
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-primary" viewBox="0 0 20 20" fill="currentColor" key={i}>
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
                ))}
                <h5 className="font-bold text-sm ml-2">{job.rating.toFixed(2)}</h5>
              </div>
              ...
              <div className="flex mt-2">
                ...
                ? <div className="w-2/3 flex">
                  <h5 className="w-1/2 text-sm"><span className="font-bold">${job.hourlyRate}</span> /hr</h5>
        ...
        <div className="p-4 mb-4">
          ...
          <div className="space-x-2">
            {freelancer.skills.map(skill => (
              <span className="px-2 py-1 text-darkText bg-gray-100 rounded-full text-sm">{skill}</span>
            ))}
          </div>
        </div>
      </div>
          ...
          <div className="text-sm mb-4">
            <ul className="space-y-1">
              {freelancer.languages.map(lang => (
                <li><span className="font-bold">{lang.language}:</span> <span className="text-gray-500">{lang.level}</span></li>
              ))}
            </ul>
          </div>
