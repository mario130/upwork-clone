      ...
      <div className="pb-2 bg-white mb-2 md:mb-6 border border-gray-200 md:rounded-lg">
        ...
        <div className="px-4 md:px-6 text-sm">
          ...
          <p className="text-gray-500 mb-2">
            ...
            this job. Feel free to suggest any changes to the job details or ask
          ...
          <textarea
            ...
            id="introduction"
            rows="4"
            className="w-full border border-gray-200 focus:outline-none rounded-lg p-4 "
        ...
        <div className="mt-4 px-3 md:px-5 pt-6 pb-3 border-t border-gray-200">
          <div className="flex md:w-96">
            ...
            <button className="flex-1 md:order-1 mx-1 py-2 rounded-lg font-bold bg-primary text-white">
              Submit a proposal
            </button>
          </div>
        </div>
