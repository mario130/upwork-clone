  ...
  return (
    ...
    <div id="login" className="py-0 md:py-5 bg-bodyGray">
      ...
      <Input type="email" name="email" placeholder="Your email" errorMsg="" className="pl-10" svg={ <svg
          ...
          <Btn className="w-full  bg-primary hover:bg-dark focus:ring-dark  text-white ">
              Continue 
          </Btn>
        ...
        <AppleBtn/>
            ...
            <Btn className="w-2/4  bg-white hover:text-dark focus:ring-dark  text-prbg-primary border border-gray-400">Sign Up</Btn>
      </div>
    </div>
