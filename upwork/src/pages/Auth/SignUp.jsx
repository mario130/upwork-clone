      ...
      <div className="mt-4 form-wrapper py-6 bg-white text-center md:w-1/2 lg:w-2/5 w-full mx-auto px-5 lg:px-20 md:rounded-lg">
        ...
        <form action="http://localhost:4001/users/checkEmail/" method="POST">
          <Input type="email" name="email" placeholder="Your email" errorMsg=""  className="pl-10" svg={ <svg
              ...
              <button className="w-full  bg-primary hover:bg-dark focus:ring-green-500  text-white  py-2 px-4 transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2  rounded-lg ">Continue with Email</button>
        </form>
