        ...
        <div className="mt-4 form-wrapper py-6 bg-white text-center md:w-1/2 lg:w-2/5 w-full mx-auto px-5 lg:px-20 md:rounded-lg">
          ...
          <form action="http://localhost:4001/users/register" method="POST">
            ...
            <div className="flex justify-center">
              <Radio name="userType" id="client" value="client">Hire</Radio>
              <Radio name="userType" id="freelancer" value="freelancer">Work</Radio>
            </div>
            <div className="flex flex-col my-4">
              <CheckBox>
                Yes! Send me genuinely useful emails every now and then to help
                me get the most out of Upwork.
              </CheckBox>
            ...
            <button className="w-full  bg-primary hover:bg-green-700 focus:ring-green-500  text-white  py-2 px-4 transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2  rounded-lg ">
            Create My Account
            </button>
