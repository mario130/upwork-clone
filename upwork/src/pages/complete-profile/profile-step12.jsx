    ...
    <>
      ...
      <div className="bg-white px-5 md:py-4">
        <div className="w-full">
          ...
          <label htmlFor="street" className="text-xs my-2 font-bold block">
            Country
          </label>
          ...
          <input
            type="text"
            className="border-gray-300 border w-full mx-1 my-2 py-2 pl-10 bg-white text-gray-700 text-sm placeholder-gray-500 shadow-sm  focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
            name="street"
            placeholder=""
          />
          <input
            type="text"
            className="border-gray-300 border w-1/2 mx-1 my-2 py-2 pl-10 bg-white text-gray-700 text-sm placeholder-gray-500 shadow-sm  focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
            name="street"
            placeholder="Apt./Suite"
          />
          <br className="mb-5" />

          <label htmlFor="city" className="text-xs mb-2 font-bold block mt-6">
            City
          </label>
          <input
            type="text"
          ...
          <label htmlFor="postalCode" className="text-xs my-2 font-bold block ">
            ZIP/Postal code
          </label>
          <input
            type="text"
