  ...
  return (
    <>
      ...
      <div className="px-5">
        ...
        <Link className="border border-gray-300 md:w-1/5 md:float-right w-1/2 justify-center bg-primary mx-4 text-white font-bold py-2 mt-4 mb-10 rounded-md hover:bg-dark"
